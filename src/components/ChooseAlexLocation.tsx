import inWeedsImg from '../assets/woods.jpg';
import behindBuildingImg from '../assets/house.jpg';
      ...
      <p className='self-center whitespace-nowrap text-center text-sm font-extrabold tracking-tight text-primary-green'>
        {((): string => {
          if (answer === undefined && hiding) {
            return 'Choose where to hide Joe';
          } else if (hiding) {
            return `You chose to hide Joe ${answer}`;
          } else {
            return `You think Joe is ${answer}`;
          }
        })()}
      </p>
    </section>
