      ...
      {account && account.address ? (
        <>
          ...
          >
            ...
            /> */}
            <p className='aspect-[2.95] w-[161px] max-w-full self-stretch overflow-hidden fill-white object-cover object-center font-bold text-xl hover:text-red-300 animate-bounce'>
              WHERE'S JOE?
            </p>
          </button>
          <Button
